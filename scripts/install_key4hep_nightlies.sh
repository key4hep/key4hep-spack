...
$SPACKCMD buildcache install -o -u podio@master
...
$SPACKCMD  view  symlink -i /cvmfs/sw-nightlies.hsf.org/key4hep/views/`date -I`/x86_64-centos7-gcc8-opt/ podio@master
...
$SPACKCMD view  symlink -i /cvmfs/sw-nightlies.hsf.org/key4hep/views/latest/x86_64-centos7-gcc8-opt/ podio@master
