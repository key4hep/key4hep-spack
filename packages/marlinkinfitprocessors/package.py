...
class Marlinkinfitprocessors(CMakePackage, Ilcsoftpackage):
    ...
    version('0.5',    sha256='0e560923e8af46b70b29973a6fda5ff459bb76e52452125b79a2397e9e0f5cfd')
    ...
    def setup_run_environment(self, env):
        env.prepend_path('MARLIN_DLL', self.prefix.lib + '/libMarlinKinfitProcessors.so')
